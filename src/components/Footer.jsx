...
//                 <img src="../images/sofa.png" alt="" srcset=""  className="" height={300} width={300}/>
//             </div>    
//                 <h3><i className="fa-regular fa-envelope text-secondary p-3"></i>Subscribe to Newsletter</h3>
//                 <Form>
//       <Row>
//         <Col  md={3}>
...
//             <Row>
//                 <Col md={4}>
//                     <p>Donec facilisis quam ut purus rutrum lobortis. Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate velit imperdiet dolor tempor tristique. Pellentesque habitant
//                     </p>   
...
function Footer() {
  return (
    <div>
        <div className='position-relative mt-5 text-start p-4'>
            <div className='position-absolute top-0 end-0 translate-middle pt-5 mt-4 '>
                <img src='./images/sofa.png' alt='' height={300} width={300}/>
            </div>

            
            <h3><i className="fa-regular fa-envelope text-secondary p-3 mx-5 "></i> Subscribe to Newsletter</h3>
            <Form>
      <Row>
        <Col md={3} className=' p-3 ms-5'>
          <Form.Control placeholder="Enter your name" />
        </Col>
        <Col md={3} className=' p-3 mx-1'>
          <Form.Control placeholder="Enter your email" />
        </Col>
        <Col>
        <Button variant="success" className='px-4 mt-3  ms-2'><i className="fa-brands fa-telegram fs-4"></i></Button>
        </Col>
      </Row>
    </Form>
        </div>
        <Container className='text-start'>
            ...
            <div className='d-flex'>
                <div className='p-2 flex-grow-1'>
                    <ul className='list-unstyled'>
                        <li>Copyright &copy; 2025. All Rights Reserved. — Designed with love </li>
                        <li>Created by Prasad S. Lonkar.</li>
                    </ul>
                </div>
                <div className='p-2'>
